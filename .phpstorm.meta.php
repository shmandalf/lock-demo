...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'queue.connections.rabbitmq.exchange' => 'string',
            'queue.connections.rabbitmq.exchange_type' => 'string',
            'queue.connections.rabbitmq.exchange_routing_key' => 'string',
            'queue.connections.rabbitmq.queue_params.passive' => 'boolean',
            'queue.connections.rabbitmq.queue_params.durable' => 'boolean',
            'queue.connections.rabbitmq.queue_params.exclusive' => 'boolean',
            'queue.connections.rabbitmq.queue_params.auto_delete' => 'boolean',
            'queue.connections.rabbitmq.queue_params.arguments.x-max-priority' => 'integer',
            'queue.connections.rabbitmq.exchange_params.name' => 'string',
            'queue.connections.rabbitmq.exchange_params.type' => 'string',
            'queue.connections.rabbitmq.exchange_params.passive' => 'boolean',
            'queue.connections.rabbitmq.exchange_params.durable' => 'boolean',
            'queue.connections.rabbitmq.exchange_params.auto_delete' => 'boolean',
...
'app.aliases.View','app.aliases.Vite','app.semaphore_class','auth.defaults.guard','auth.defaults.passwords',
...
'queue.connections.failover.driver','queue.connections.failover.connections','queue.connections.rabbitmq.driver','queue.connections.rabbitmq.queue','queue.connections.rabbitmq.connection',
'queue.connections.rabbitmq.hosts.0.host','queue.connections.rabbitmq.hosts.0.port','queue.connections.rabbitmq.hosts.0.user','queue.connections.rabbitmq.hosts.0.password','queue.connections.rabbitmq.hosts.0.vhost',
'queue.connections.rabbitmq.options.ssl_options.cafile','queue.connections.rabbitmq.options.ssl_options.local_cert','queue.connections.rabbitmq.options.ssl_options.local_key','queue.connections.rabbitmq.options.ssl_options.verify_peer','queue.connections.rabbitmq.options.ssl_options.passphrase',
'queue.connections.rabbitmq.options.queue.job','queue.connections.rabbitmq.worker','queue.connections.rabbitmq.exchange','queue.connections.rabbitmq.exchange_type','queue.connections.rabbitmq.exchange_routing_key',
'queue.connections.rabbitmq.queue_params.passive','queue.connections.rabbitmq.queue_params.durable','queue.connections.rabbitmq.queue_params.exclusive','queue.connections.rabbitmq.queue_params.auto_delete','queue.connections.rabbitmq.queue_params.arguments.x-max-priority',
'queue.connections.rabbitmq.exchange_params.name','queue.connections.rabbitmq.exchange_params.type','queue.connections.rabbitmq.exchange_params.passive','queue.connections.rabbitmq.exchange_params.durable','queue.connections.rabbitmq.exchange_params.auto_delete',
...
'index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','WWWGROUP',
'WWWUSER','SEMAPHORE_CLASS','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','VITE_PUSHER_APP_KEY',
'VITE_PUSHER_HOST','VITE_PUSHER_PORT','VITE_PUSHER_SCHEME','VITE_PUSHER_APP_CLUSTER','PUSHER_APP_ID',
'PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_HOST','PUSHER_PORT','PUSHER_SCHEME',
'PUSHER_APP_CLUSTER','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','RABBITMQ_HOST','RABBITMQ_PORT','RABBITMQ_QUEUE','RABBITMQ_USER',
'RABBITMQ_PASS','RABBITMQ_VHOST','BROADCAST_DRIVER','BROADCAST_CONNECTION','FILESYSTEM_DISK',
