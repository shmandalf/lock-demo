    ...
    */
    ...
    'connections' => [
            ...
            */
            ...
            'hosts' => [
                [
                    ...
                    'password' => env('RABBITMQ_PASS', 'admin'),
                    'vhost' => env('RABBITMQ_VHOST', '/'),
                ],
            ],
            ...
            'exchange_routing_key' => env('RABBITMQ_QUEUE', 'semaphore_tasks'),
        ...
        'redis' => [
            ...
            'block_for' => 5, // Блокирующее ожидание новых задач
            'after_commit' => true, // Ждать коммит транзакции
        ],
